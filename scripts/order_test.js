...
const customerID = '689108d2-fe45-447e-bd5e-981f8b53104d';
const ticketID = '74c69f1d-3bc1-4be4-a521-951cdf554639';
...
export function setup() {
  ...
  if (ticketData.data.quantity === 0) {
    ...
    const ticketQuantityPayload = JSON.stringify({ quantity: 100 });
  ...
  if (customerData.data.balance === 0) {
    ...
    const balancePayload = JSON.stringify({ balance: 100000 });
